...
int main(int argc, char **argv)
{
	...
	/*
	   NNLC [file.nnl] [c/nc - compile/don't compile]
	   Executable: [0]
	   File: [1]
	   Compile: [2]
	*/
...

	{
		...
		c = NNLC::process_c(c); // Process C so that it cuts off anything past a comment ;

		sourceFile = NNLC::declare_function(a) + sourceFile;

		sourceFile += NNLC::process_line(a, b, c, &includes);
	}
